$(function () {
    $('#Form_DirectDebitForm button').click(function (e) {
        e.preventDefault();
    });
    ...
    $("#Form_DirectDebitForm").validate();

/*    $('#Form_DirectDebitForm_Application_dob').rules("add", {
        dob: true,
        messages: {
...
//            //minlength: jQuery.format("Oops! At least {0} characters are necessary")
    ...
    $('#Form_DirectDebitForm_Application_YourPhoneNumber').rules("add", {
        phone: true,
        messages: {
