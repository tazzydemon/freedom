...
class SignUp2014 extends UserDefinedForm {
...
class SignUp_Controller2014 extends Page_Controller {
...
//        fb($decrequest);
       ...
       // $streetOrPropertyName = str_replace('road', 'r', $streetOrPropertyName);
        ...
        if (strpos($region, 'Manawatu') !== false || strpos($region, 'Wanganui') !== false || strpos($region, 'Waikato') !== false || strpos($region, 'Nelson')) {
